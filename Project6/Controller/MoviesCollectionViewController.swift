...
//            cell.priceLabel.text = "$" + String(format: "%.2f", state.trackPrice!)
            ...
            if let cachedImage = DataManager.sharedInstance.imageCache.object(forKey: (state.artworkUrl100 ?? "") as NSString) {
                print("DEBUG ----> cached image")
                cell.imageView.image = cachedImage
                
                // Make sure that you account for the average color backgrounds of the collection view cells
